...
const SearchBox = () => {
    return <Container maxWidth="xl" style={{ backgroundColor: 'white', boxShadow: '2px 2px 20px rgba(0, 0, 0, 0.1)', borderRadius: '15px', height: '20rem', position: 'absolute', left: '50%', transform: 'translate(-50%, -90%)' }}>
